...
const handleScroll = (id: string) => {
  ...
  return (
    <section className="w-full px-6 md:px-16 py-15 pb-5 md:py-5 mb-12 text-center md:bg-none bg-gradient-to-b from-[var(--neutral-900)] to-[var(--primary-500)] backdrop-blur-md">
        <motion.div
        ...
        >
            <div className="relative justify-center h-full md:pt-15 pb-10 max-w-3xl mx-auto">
            ...
            <div className="relative justify-center h-full pb-7 md:pb-15 max-w-6xl mx-auto">
